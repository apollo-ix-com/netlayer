            ...
            <div className="col-lg-6 mt-50">
              <div className="about-left">
                ...
                <div className="about-item_box ul_li">
                  ...
                  <div className="xb-item--holder">
                    <p className="xb-item--content">
                      <span>Innovation:</span> Continuously refining SEO to stay
                      ahead of search engine updates.
                    </p>
                  </div>
                </div>
                <div className="about-item_box ul_li">
                ...
                <div className="about-item_box ul_li">
                  ...
                  <div className="xb-item--holder">
                    <p className="xb-item--content">
                      <span>Transparency:</span> Clear communication and honest
              ...
              <div className="about-right">
                ...
                <div className="xb-item--holder">
                  ...
                  <p className="xb-item--content">
                    ...
                    setting the standard for ethical SEO. We empower businesses
                    to thrive with effective, strategies.
                  </p>
                </div>
              </div>
            </div>
